    ...
    <div class="col p-0">
        <div class="card">
            ...
            <div class="card-header">
                <div class="row">
                    <div class="col">
                        <h3 class="mb-0">Edit Tentang Desa</h3>
                    </div>
                </div>
            </div>
            <!-- Card body -->
                    ...
                    <div class="col-lg-8">
                        <form method="post" action="/dashboard/about/1" enctype="multipart/form-data" autocomplete="off">
                            ...
                            <div class="form-group">
                                ...
                                @enderror
                                <textarea name="content" id="content" class=" @error('content') is-invalid @enderror">{{ old('content', $about->content) }}</textarea>
                            </div>
                            
                            <div class="form-group mt-3">
                                <button type="submit" class="btn btn-primary">Simpan</button>
                                <a href="/dashboard/about" class="btn btn-secondary">Batal</a>
                            </div>
                        </form>
                    </div>
                </div>
