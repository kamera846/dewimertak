    ...
    <div class="col p-0">
        <div class="card">
            ...
            <div class="card-header">
                <div class="row">
                    <div class="col">
                        <h3 class="mb-0">Buat Acara & Kegiatan</h3>
                    </div>
                </div>
            </div>
            <!-- Card body -->
            <div class="card-body pt-4 pb-2">
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <form method="post" action="/dashboard/events" enctype="multipart/form-data" autocomplete="off">
                            ...
                            {{-- <div class="form-group row">
                                ...
                                >
                                <div class="col-md-10">
                                    <textarea name="title" id="title" rows="4" class="form-control @error('title') is-invalid @enderror" required>{{  old('title')  }}</textarea>
                                    @error('title')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
