...
<div class="header bg-primary pb-6">
    <div class="container-fluid">
        <div class="header-body">
            ...
            {{-- Flash Message --}}
            <div id="flash-data" data-session="{{ session()->has('success') ? 'success' : '' }}" data-message="{{ session()->has('success') ? session('success') : '' }}"></div>
            ...
            <div class="card">
                ...
                <div class="card-body p-0">
                    ...
                    >
                        ...
                        >
                            <div
                                class="checklist-item checklist-item-success"
                            >
                        ...
                        >
                            <div
                                class="checklist-item checklist-item-warning"
                            >
                                <div class="checklist-info">
                                    <h5
                                        class="checklist-title mb-0"
                        ...
                        >
                            <div
                                class="checklist-item checklist-item-danger"
                            >
                                <div class="checklist-info">
                                    <h5
                                        class="checklist-title mb-0"
                        ...
                        <li class="list-group-item px-0">
                            <div class="row align-items-center">
                                ...
                                <div class="col">
                                    ...
                                    <div
                                        class="progress progress-xs mb-0"
                                    >
                                        <div
    ...
    <div class="row">
        <div class="col-xl-5">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="mb-4">
                        Personal profiles are the perfect way for
                        you to grab their attention and persuade
                        recruiters to continue reading your CV
                        because you’re telling them from the off
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                ...
                                >
                                <div
                                    class="progress progress-xs my-2"
                                >
                                    <div
                                        class="progress-bar bg-success"
                                        style="width: 60%"
